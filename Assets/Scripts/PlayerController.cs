...
public class PlayerController : MonoBehaviour {
    ...
    private void HandleVineHit(GameObject vine) {
        
        if (Input.GetKey("space")) {
            Debug.Log("i hit space");
            if (this.transform.parent == null) {
                this.m_GravityMultiplier = 0;
                this.m_WalkSpeed = 0;
                this.m_RunSpeed = 0;
                this.m_JumpSpeed = 0;
                this.transform.parent = vine.transform;
            }
        }
